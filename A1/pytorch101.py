...
def multiples_of_ten(start, stop):
  ...
  for i, val in enumerate(range(start, stop, 10)):
    x[i] = val
  print(x)
  #############################################################################
  #                            END OF YOUR CODE                               #
...
def reshape_practice(x):
  ...
  #############################################################################
  # Replace "pass" statement with your code
  y = x.reshape((6,4)).reshape((2,3,4)).T.reshape((4,6)).T.reshape((3,8))
  #############################################################################
  #                            END OF YOUR CODE                               #
  #############################################################################
  return y
...
def normalize_columns(x):
  ...
  # Replace "pass" statement with your code
  (M, N) = x.shape
  mean = torch.sum(x, dim=0, keepdim=True)/M
  std = torch.sqrt(torch.sum((mean - x)**2, dim=0, keepdim=True)/(M-1))
  y = (x - mean) / std
  #############################################################################
  #                            END OF YOUR CODE                               #
  #############################################################################
